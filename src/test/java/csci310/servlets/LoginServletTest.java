...
public class LoginServletTest {
    ...
    public static void dbSetup() {
        ...
        coll.deleteOne(DBConnector.usernameFilter(USERNAME));
    ...
    private enum TestCase {
        ...
        final String joined,rsa,result;
        TestCase(final String iv,final String key,
                 final String msg,final String rsa) {
            joined = String.join(",",iv,key,msg);
            this.rsa = rsa;
            result = name();
        }
        /* TODO use if strings change from enum name
        TestCase(final String iv,final String key,final String msg,final String result) {
            this.iv = iv;
            this.key = key;
            this.msg = msg;
            this.result = result;
        ...
        */
        ...
        void exec(final LoginServlet lis) {
            try {
    ...
    public void testDoPost() {
        for(final TestCase t : TestCase.values())
            t.exec(lis);
    }
}