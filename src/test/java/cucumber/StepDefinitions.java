...
public class StepDefinitions {
    ...
    public void i_enter_the_username(String username) {
        driver.findElement(By.cssSelector("#login_box_container>form>div>input[type=text]"))
              .sendKeys(username);
    }
    
    @And("I enter the password {string}")
    public void i_enter_the_password(String password) {
        driver.findElement(By.cssSelector("#login_box_container>form>div>input[type=password]"))
              .sendKeys(password);
    }
